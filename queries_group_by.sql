...
/*
Challenge 1 Solution - How many customers do we have in the City of Berlin Expected : 2
...
/*
Challenge 2 Solution - How much has been made in sales for the track "The Woman King". Expected : 3.98
...
/*
Challenge 3 Solution - Create a list of the top 5 acts by number of tracks. The table should include the
