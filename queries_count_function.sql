...
/*
Challenge 1 and Solution - How Many Customers is Employee 4 the Sales Support Agent For?
*/
SELECT COUNT(*) FROM Customer WHERE SupportRepId = 4;

/*
Challenge 2 and Solution - How Many Customers is Jane Peacock the Sales Support Agent For?
*/
...
/*
Challenge 3 and Solution - Which Media Type is most popular? How could you answer this with a single query?
